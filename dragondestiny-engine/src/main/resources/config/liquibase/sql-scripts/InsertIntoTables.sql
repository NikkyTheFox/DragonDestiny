...
-- FIELDS
INSERT INTO fields (type, x_position, y_position, board_id)
VALUES
    -- y 0
    ('TAKE_ONE_CARD', 0, 0, 1),
    ('TAKE_ONE_CARD', 1, 0, 1),
...
VALUES ('Dahamut', 'Dragon', 'Dahamut was born in a loving family. His parents were killed by his uncle when he was 2 months old. Since then, he craves for revenge.', 4, 8, 1)

INSERT INTO games_characters
SELECT IDENT_CURRENT('games'), (SELECT IDENT_CURRENT('characters'))

INSERT INTO characters
VALUES ('Carixus', 'Dragon', 'Carixus is an orphan dragon found and raised by wolves. He is very compassionate and does not like to fight.', 6, 7, 2)

INSERT INTO games_characters
SELECT IDENT_CURRENT('games'), (SELECT IDENT_CURRENT('characters'))

INSERT INTO characters
VALUES ('Fergusso', 'Dragon', 'Fergusso is a crazy vegetarian dragon that decided not to eat meat anymore after seeing a little puppy. He is though very aggressive for his territory.', 8, 5, 3)

INSERT INTO games_characters
SELECT IDENT_CURRENT('games'), (SELECT IDENT_CURRENT('characters'))

INSERT INTO characters
VALUES ('Amazonija', 'Dragon', 'Amazonija comes from a long family of fighters. She was trained to fight since she was a newborn child.', 7, 6, 4)

INSERT INTO games_characters
SELECT IDENT_CURRENT('games'), (SELECT IDENT_CURRENT('characters'))

INSERT INTO characters
VALUES ('Cinder', 'Dragon', 'Cinder had a very damageable childhood - she was thrown into a volcano as a child. Her scales and claves adapted to the heat of lava and she become almost indestructible.', 2, 10, 5)

INSERT INTO games_characters
SELECT IDENT_CURRENT('games'), (SELECT IDENT_CURRENT('characters'))

INSERT INTO characters
VALUES ('Florina', 'Dragon', 'Florina is a venom spitting dragon that takes her power from poisonous flowers. She hates killing animals.', 3, 8, 6)
