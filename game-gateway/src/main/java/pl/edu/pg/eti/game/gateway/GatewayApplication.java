        ...
        return builder
                ...
                .route("playedgames", r -> r
                        .path("/api/playedgames",
                                ...
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/used/{cardId}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/hand/{cardId}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/trophies/{cardId}",
                                ...
                                "/api/playedgames/{playedGameId}/players/{playerLogin}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/character",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/hand",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/hand/health",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/hand/{cardId}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/cards/trophies",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/character/{characterId}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/field/{fieldId}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/block/{blockedNum}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/block",
                                "/api/playedgames/{playedGameId}/cards/deck/draw",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/roll",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/roll/{playerRoll}/enemy/{cardId}/roll/{enemyRoll}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/roll/{playerRoll}/enemy/roll/{enemyRoll}",
                                "/api/playedgames/{playedGameId}/players/{playerLogin}/roll/{playerRoll}"
                                )
                        .uri("lb://played-game"))
                .route("games", r -> r
                        .path(
