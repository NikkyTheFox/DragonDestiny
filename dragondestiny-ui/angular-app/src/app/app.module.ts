...
import { MainSectionBoardFieldPawnComponent } from './game-ui-playboard/main-section-board-field-pawn/main-section-board-field-pawn.component';
import { RighthandSidebarGameControlOptionsComponent } from './game-ui-playboard/righthand-sidebar-game-control-options/righthand-sidebar-game-control-options.component';
...
@NgModule({
  declarations: [
    ...
    JoinGameComponent,
    MainSectionBoardFieldPawnComponent,
    RighthandSidebarGameControlOptionsComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
